(() => {
  ...
  function firstMoneyLike(values) {
    return values.find(value => /\d/.test(value)) || values[0] || '';
  }
  ...
  function invoiceSummaryRow(data) {
    const sellerName = fieldValue(data, 'seller', ['نام فروشنده', 'فروشنده', 'نام شرکت', 'نام']);
    ...
    const invoiceTotal = fieldValue(data, 'payment', ['مجموع صورتحساب', 'مبلغ نهایی', 'مبلغ قابل پرداخت', 'جمع کل', 'total amount', 'final amount']) || firstMoneyLike([...
  ...
  function workbookFiles(sheets) {
    return [
      ...
      { name: 'xl/styles.xml', data: `<?xml version="1.0"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><fonts count="2"><font><name val="Vazirmatn"/></font><font><b/><color rgb="FF000000"/><name val="Vazirmatn"/></font></fonts><fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FF92D050"/></patternFill></fill></fills><borders count="1"><border><left style="thin"/><right style="thin"/><top style="thin"/><bottom style="thin"/></border></borders><cellXfs count="2"><xf fontId="0" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1" readingOrder="2"/></xf><xf fontId="1" fillId="1" borderId="0" xfId="0" applyFill="1" applyFont="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1" readingOrder="2"/></xf></cellXfs></styleSheet>` },
