...
5. پس از تنظیم اولیه، با کلیک روی آیکن افزونه صفحه به‌صورت خودکار اسکن می‌شود و می‌توانید Excel بگیرید یا داده‌ها را در تب جدید Google Sheets باز کنید. هر قلم صورتحساب در یک ردیف جداگانه خروجی می‌آید و صورتحساب‌های جدید به ردیف‌های پایین فایل اضافه می‌شوند.
