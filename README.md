...
- `popup.html`, `popup.js` — داشبورد، پیش‌نمایش، خروجی Excel و باز کردن Google Sheets با داده‌های کپی‌شده برای جای‌گذاری.
...
5. پس از تنظیم اولیه، با کلیک روی آیکن افزونه صفحه به‌صورت خودکار اسکن می‌شود و می‌توانید Excel بگیرید یا داده‌ها را در تب جدید Google Sheets باز کنید. هر صورتحساب جدید به ردیف‌های پایین فایل خروجی اضافه می‌شود و اگر «مبلغ واحد» برای چند کالا متفاوت باشد، مقادیر با خط فاصله کنار هم قرار می‌گیرند.
