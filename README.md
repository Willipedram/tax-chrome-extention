...
5. روی «دریافت فایل Excel» کلیک کنید. هر صورتحساب جدید به ردیف‌های پایین فایل خروجی اضافه می‌شود و اگر «مبلغ واحد» برای چند کالا متفاوت باشد، مقادیر با خط فاصله کنار هم قرار می‌گیرند.
